...
DISTILL_CONFIG=(
    ...
    distillation.teacher_models.teacher_model.model_path=${hf_model_path}/Qwen3-VL-32B-Instruct
...
# ===================================== Trainer Config =====================================
project_name='DISTILLATION-Qwen3-VL-8B-Instruct-BASE-GEO3K'
exp_name='DISTILLATION-Qwen3-VL-8B-Instruct-BASE-FSDP-vLLM'
ngpus_per_node=4

---
name: script-formatting-on-step-off-policy
description: Convention for formatting verl on-step-off-policy shell scripts — parameter grouping, bash arrays, section headers
---
...
8. **Project and experiment names**: Every script MUST define `project_name` and `exp_name`. If the original script doesn't have them, auto-generate following this pattern:
   ...
   - **project_name**: `One_Step_Off_Policy-<ModelName>-BASE-<Dataset>`
   ...
   - **exp_name**: `One_Step_Off_Policy-<ModelName>-BASE-<TrainBackend>-<InferBackend>`
